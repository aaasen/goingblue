 ...
 * The quantized cloud-cover step (0..7, 3-bit — see the cloud columns in v3.ts) is bounded, so the
...
const STEP_BITS = 3;               // matches the cloud column width in v3.ts (steps 0..7)
