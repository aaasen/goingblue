 ...
 *
 * Tables land in packages/protocol/src/codebooks/temperature.gen.ts via `pnpm generate`; run standalone
 * (below) to derive and print without writing:
 *
 *   pnpm exec tsx packages/codec-server/scripts/derive-temperature-codebooks.ts
 */
