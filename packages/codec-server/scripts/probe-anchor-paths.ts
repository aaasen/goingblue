 ...
 * aggregation + codec (buildLayoutMessage → encodeBreakdown). Per step it reports fit % against
...
const MAX_PERIODS = 256; // 1 << WIRE_SEQ_BITS — every candidate layout must stay under it
