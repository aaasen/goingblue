...
const VARIABLES: VarInfo[] = [
  ...
  { name: 'Pressure-level wind', desc: 'Wind at any of the 300, 400, 500, 600, 700, 850, and 925 hPa levels (~30,000 ft down to ~2,500 ft), each selectable on its own.', agg: 'Peak sustained speed; dominant direction weighted by speed' },
