...
const VARIABLES: VarInfo[] = [
  ...
  { name: 'Wind', desc: 'Wind speed and direction at 10 m above ground.', agg: 'Peak gust speed; dominant direction weighted by speed' },
  { name: '500 hPa wind', desc: 'Wind at ~18,000 ft (upper troposphere / jet-stream level).', agg: 'Peak gust speed; dominant direction weighted by speed' },
  { name: '600 hPa wind', desc: 'Wind at ~14,000 ft.', agg: 'Peak gust speed; dominant direction weighted by speed' },
  { name: '700 hPa wind', desc: 'Wind at ~10,000 ft.', agg: 'Peak gust speed; dominant direction weighted by speed' },
