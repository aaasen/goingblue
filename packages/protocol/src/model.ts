...
export interface Period {
  ...
  // Cloud cover by pressure level (v3): one percentage per LEADING entry of
  ...
  // truncates the stack at one level below the forecast point (cloudBandLevelCount in v3.ts),
