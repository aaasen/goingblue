...
// must mirror the freeze column width in wire.ts (0..31)
...
// (see the temp column in wire.ts).
...
// format and pinned in WIRE_CODEBOOKS below.
//
...
// ── Book aliases ────────────────────────────────────────────────────────────────
// The books under standalone names, for tests and analysis scripts. The wire codec itself goes
// through BOOKS.
