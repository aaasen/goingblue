...
// Priority-mode fill layout (v3 of the fill scheme). v1 is shipped and frozen in
// its own container, so changes here land in the current version and never move v1's bits (see VERSIONING.md).
