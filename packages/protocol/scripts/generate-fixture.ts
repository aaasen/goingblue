...
// (precip, temp, dewpoint, snow, rain, freeze, surface wind + every pressure level, gust, the
// cloud band, and all twelve air-quality indices). With every sub-index present, BOTH headlines encode under
...
// elevation freezes its level run (4267 m → six levels, 250..700 hPa: two below the point, the
// 6-level minimum pulling the top past the 300 cap); the seven requested
// wind levels are all carried, clamp-free — see cloudBandPeriodCount / cloudBandLevelRange in
...
const input: ForecastMessage = {
  ...
  periods: [[
    { weathercode: 3,  precip: 57, temp_c: -8,  dewpoint_c: -14, snow_cm: 0, rain_mm: 0,   freeze_m: 3048,   wind_sfc_kph: 16, wind_sfc_dir: 5, wind_gust_kph: 30, wind_aloft: [{ kph: 72, dir: 4 }, { kph: 60, dir: 4 }, { kph: 48, dir: 4 }, { kph: 40, dir: 3 }, { kph: 24, dir: 2 }, { kph: 16, dir: 2 }, { kph: 12, dir: 3 }], cloud_band: [65, 60, 55, 40, 35, 30], aqi: 118, aqi_pm25: 96,  aqi_o3: 42, aqi_eu: 55,  aqi_eu_pm25: 31, aqi_eu_o3: 50, aqi_eu_pm10: 24, aqi_eu_no2: 15, aqi_eu_so2: 7, aqi_pm10: 61, aqi_no2: 19, aqi_so2: 10, aqi_dominant: 0, aqi_eu_dominant: 1 },
    { weathercode: 61, precip: 86, temp_c: -4,  dewpoint_c: -6, snow_cm: 5, rain_mm: 3.5, freeze_m: 2438.4, wind_sfc_kph: 24, wind_sfc_dir: 5, wind_gust_kph: 45, wind_aloft: [{ kph: 80, dir: 3 }, { kph: 68, dir: 3 }, { kph: 56, dir: 3 }, { kph: 48, dir: 3 }, { kph: 32, dir: 3 }, { kph: 24, dir: 3 }, { kph: 20, dir: 4 }], cloud_band: [92, 90, 85, 75, 70, 65], aqi: 165, aqi_pm25: 160, aqi_o3: 38, aqi_eu: 72,  aqi_eu_pm25: 44, aqi_eu_o3: 41, aqi_eu_pm10: 33, aqi_eu_no2: 18, aqi_eu_so2: 8, aqi_pm10: 74, aqi_no2: 22, aqi_so2: 11, aqi_dominant: 0, aqi_eu_dominant: 0 },
    { weathercode: 63, precip: 92, temp_c: -3,  dewpoint_c: -4, snow_cm: 7, rain_mm: 5.2, freeze_m: 2286,   wind_sfc_kph: 30, wind_sfc_dir: 4, wind_gust_kph: 52, wind_aloft: [{ kph: 84, dir: 3 }, { kph: 72, dir: 3 }, { kph: 60, dir: 3 }, { kph: 52, dir: 2 }, { kph: 36, dir: 3 }, { kph: 28, dir: 3 }, { kph: 24, dir: 4 }], cloud_band: [97, 95, 90, 85, 80, 75], aqi: 172, aqi_pm25: 168, aqi_o3: 35, aqi_eu: 78,  aqi_eu_pm25: 48, aqi_eu_o3: 38, aqi_eu_pm10: 36, aqi_eu_no2: 19, aqi_eu_so2: 8, aqi_pm10: 78, aqi_no2: 23, aqi_so2: 11, aqi_dominant: 0, aqi_eu_dominant: 0 },
    { weathercode: 71, precip: 64, temp_c: -6,  dewpoint_c: -9, snow_cm: 3, rain_mm: 0,   freeze_m: 2590.8, wind_sfc_kph: 20, wind_sfc_dir: 5, wind_gust_kph: 38, wind_aloft: [{ kph: 76, dir: 4 }, { kph: 64, dir: 4 }, { kph: 52, dir: 4 }, { kph: 44, dir: 3 }, { kph: 28, dir: 2 }, { kph: 20, dir: 2 }, { kph: 16, dir: 3 }], cloud_band: [75, 70, 65, 60, 55, 45], aqi: 130, aqi_pm25: 124, aqi_o3: 40, aqi_eu: 61,  aqi_eu_pm25: 36, aqi_eu_o3: 43, aqi_eu_pm10: 28, aqi_eu_no2: 16, aqi_eu_so2: 7, aqi_pm10: 66, aqi_no2: 20, aqi_so2: 10, aqi_dominant: 0, aqi_eu_dominant: 1 },
    { weathercode: 2,  precip: 14, temp_c: -12, dewpoint_c: -20, snow_cm: 0, rain_mm: 0,   freeze_m: 3352.8, wind_sfc_kph: 8,  wind_sfc_dir: 6, wind_gust_kph: 15, wind_aloft: [{ kph: 56, dir: 5 }, { kph: 44, dir: 5 }, { kph: 32, dir: 5 }, { kph: 24, dir: 4 }, { kph: 16, dir: 5 }, { kph: 8, dir: 5 }, { kph: 4, dir: 6 }], cloud_band: [15, 10, 5, 5, 0, 0],  aqi: 22,  aqi_pm25: 8,   aqi_o3: 21, aqi_eu: 12,  aqi_eu_pm25: 9, aqi_eu_o3: 11, aqi_eu_pm10: 7, aqi_eu_no2: 5, aqi_eu_so2: 3, aqi_pm10: 15, aqi_no2: 8, aqi_so2: 4, aqi_dominant: 1, aqi_eu_dominant: 1 },
    { weathercode: 71, precip: 43, temp_c: -10, dewpoint_c: -13, snow_cm: 2, rain_mm: 0,   freeze_m: 2743.2, wind_sfc_kph: 12, wind_sfc_dir: 4, wind_gust_kph: 25, wind_aloft: [{ kph: 64, dir: 4 }, { kph: 52, dir: 4 }, { kph: 40, dir: 4 }, { kph: 32, dir: 4 }, { kph: 20, dir: 3 }, { kph: 12, dir: 3 }, { kph: 8, dir: 4 }], cloud_band: [85, 80, 70, 55, 50, 40], aqi: 88,  aqi_pm25: 85,  aqi_o3: 30, aqi_eu: 41,  aqi_eu_pm25: 26, aqi_eu_o3: 30, aqi_eu_pm10: 19, aqi_eu_no2: 12, aqi_eu_so2: 6, aqi_pm10: 52, aqi_no2: 17, aqi_so2: 8, aqi_dominant: 0, aqi_eu_dominant: 1 },
    { weathercode: 3,  precip: 29, temp_c: -7,  dewpoint_c: -12, snow_cm: 0, rain_mm: 1.2, freeze_m: 2895.6, wind_sfc_kph: 20, wind_sfc_dir: 3, wind_gust_kph: 35, wind_aloft: [{ kph: 68, dir: 2 }, { kph: 56, dir: 2 }, { kph: 44, dir: 2 }, { kph: 36, dir: 2 }, { kph: 28, dir: 1 }, { kph: 20, dir: 1 }, { kph: 16, dir: 2 }], cloud_band: [55, 50, 40, 35, 30, 25], aqi: 51,  aqi_pm25: 12,  aqi_o3: 50, aqi_eu: 33,  aqi_eu_pm25: 14, aqi_eu_o3: 32, aqi_eu_pm10: 11, aqi_eu_no2: 9, aqi_eu_so2: 4, aqi_pm10: 20, aqi_no2: 13, aqi_so2: 6, aqi_dominant: 1, aqi_eu_dominant: 1 },
    { weathercode: 61, precip: 71, temp_c: -5,  dewpoint_c: -7, snow_cm: 1, rain_mm: 2.1, freeze_m: 2590.8, wind_sfc_kph: 28, wind_sfc_dir: 2, wind_gust_kph: 55, wind_aloft: [{ kph: 76, dir: 1 }, { kph: 64, dir: 1 }, { kph: 52, dir: 1 }, { kph: 44, dir: 1 }, { kph: 36, dir: 0 }, { kph: 28, dir: 0 }, { kph: 24, dir: 1 }], cloud_band: [88, 85, 80, 70, 65, 60], aqi: 210, aqi_pm25: 205, aqi_o3: 45, aqi_eu: 105, aqi_eu_pm25: 66, aqi_eu_o3: 48, aqi_eu_pm10: 51, aqi_eu_no2: 21, aqi_eu_so2: 9, aqi_pm10: 96, aqi_no2: 25, aqi_so2: 12, aqi_dominant: 0, aqi_eu_dominant: 0 },
  ]],
};
