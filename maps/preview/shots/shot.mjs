...
const VIEWS = JSON.parse(process.env.VIEWS || `[["world", 30, -100, 2.5], ["colorado_z8", 39.1, -106.5, 8],
...
await page.goto(process.env.PAGE || "http://localhost:8471/work.html", { waitUntil: "load" });
